...
var starPreviewTexture = THREE.ImageUtils.loadTexture( 'images/star_preview.png' );
	...
	$('#starDataTbl').DataTable( {
	  ...
	  scrollCollapse: true,
		columns: [
		  ...
		  $('#starDataTbl tbody').on( 'click', 'tr', function(){reZoomTable(this) });
